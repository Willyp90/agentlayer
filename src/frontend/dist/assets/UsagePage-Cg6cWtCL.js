import { f as commonjsGlobal, n as getDefaultExportFromCjs, r as reactExports, R as React, o as invariant, j as jsxRuntimeExports, p as useUsageSummary } from "./index-BZePS1Zd.js";
...
function CustomTooltip({ active, payload, label }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded px-3 py-2 shadow-lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs text-muted-foreground mb-0.5", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono text-sm text-foreground tabular-nums", children: [
...
function DailyChart({ data }) {
  const chartData = data.slice(-30).map((d2) => ({
    date: d2.date,
    calls: Number(d2.count)
  }));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 180, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    AreaChart,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "callsGradient", x1: "0", y1: "0", x2: "0", y2: "1", children: [
...
function formatBigInt(n2) {
  if (n2 === void 0) return "0";
  return Number(n2).toLocaleString();
}
function computePct(count, total) {
  if (total <= 0n) return 0;
  return Math.round(Number(count * 1000n / total) / 10);
}
const SKELETON_STATS = ["s1", "s2", "s3"];
const SKELETON_ROWS = ["r1", "r2", "r3", "r4", "r5"];
function StatCard({ label, value, accent }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `border border-border rounded p-3 md:p-4 bg-card flex flex-col gap-1.5 md:gap-2 ${accent ? "border-accent/40 bg-accent/5" : ""}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono text-muted-foreground uppercase tracking-[0.12em] leading-tight", children: label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: `font-mono text-xl md:text-2xl font-semibold tabular-nums leading-none ${accent ? "text-accent" : "text-foreground"}`,
            children: value
          }
        )
      ]
...
function RankBar({ pct }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-end gap-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 md:w-20 h-1 bg-secondary rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-[11px] text-muted-foreground w-7 md:w-8 text-right tabular-nums", children: [
      pct,
      "%"
    ] })
  ] });
}
function CapabilityTable({ rows, total, isLoading }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border border-border rounded overflow-hidden overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-[12px] min-w-[320px]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border bg-secondary/30", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-2 text-left font-mono text-muted-foreground w-8", children: "#" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-2 text-left font-mono text-muted-foreground", children: "capability" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-2 text-right font-mono text-muted-foreground", children: "calls" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-3 py-2 text-right font-mono text-muted-foreground w-28 md:w-36", children: "share" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
      isLoading ? SKELETON_ROWS.map((k2) => /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { className: "border-b border-border last:border-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 4, className: "px-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-full" }) }) }, k2)) : rows.slice(0, 5).map((c2, i) => {
        const pct = computePct(c2.count, total);
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            className: "border-b border-border last:border-0 hover:bg-secondary/20 transition-colors",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 font-mono text-muted-foreground tabular-nums", children: i + 1 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 font-mono text-foreground max-w-[120px] md:max-w-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "truncate block", children: [
                c2.name,
                "()"
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 font-mono text-foreground text-right tabular-nums", children: Number(c2.count).toLocaleString() }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RankBar, { pct }) })
            ]
          },
          c2.name
        );
      }),
      !isLoading && rows.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "td",
        {
          colSpan: 4,
...
function SectionLabel({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-[10px] font-mono text-muted-foreground uppercase tracking-[0.14em] mb-3", children });
}
function UsagePage() {
  const { data: summary, isLoading, dataUpdatedAt } = useUsageSummary();
  const total = (summary == null ? void 0 : summary.totalCalls) ?? 0n;
  const thisMonth = (summary == null ? void 0 : summary.callsThisMonth) ?? 0n;
  const capabilityCount = (summary == null ? void 0 : summary.perCapability.length) ?? 0;
  const lastUpdated = dataUpdatedAt ? new Date(dataUpdatedAt).toLocaleTimeString([], {
    hour: "2-digit",
    minute: "2-digit",
    second: "2-digit"
  }) : null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full overflow-auto", "data-ocid": "usage-page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-border px-4 md:px-6 py-3 bg-card flex items-center justify-between shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-mono text-sm font-semibold text-foreground tracking-tight", children: "Your Usage" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono text-muted-foreground bg-secondary px-2 py-0.5 rounded border border-border hidden sm:inline", children: "read-only · refreshes every 30s" })
      ] }),
      lastUpdated && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-mono text-muted-foreground hidden sm:block", children: [
        "updated ",
        lastUpdated
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 md:p-6 space-y-6 md:space-y-8 max-w-6xl w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Overview" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "grid grid-cols-2 gap-3 md:grid-cols-3",
            "data-ocid": "usage-stats",
            children: isLoading ? SKELETON_STATS.map((k2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Skeleton,
              {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "This Month", value: formatBigInt(thisMonth) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                StatCard,
                {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Daily Call Volume — last 30 days" }),
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-[160px] md:h-[180px] w-full rounded" }) : ((summary == null ? void 0 : summary.dailyCounts) ?? []).length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "border border-border rounded p-8 text-center",
            "data-ocid": "usage-daily-empty",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-mono", children: "no daily data yet" })
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(DailyChart, { data: (summary == null ? void 0 : summary.dailyCounts) ?? [] })
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionLabel, { children: "Top 5 Capabilities" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CapabilityTable,
          {
            rows: (summary == null ? void 0 : summary.perCapability) ?? [],
            total,
            isLoading
          }
        )
