...
- Expanded auto-generated capability coverage with:
  - optional-field combination tests,
  - explicit malformed-JSON error-handling tests,
  - canonical smoke input selection (prefer documented example input for determinism/schema checks).
